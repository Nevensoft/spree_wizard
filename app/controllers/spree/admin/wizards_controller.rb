module Spree
  module Admin
    class WizardsController < Spree::Admin::ResourceController
      ...
      def create
        ...
        respond_to do |format|
          if @wizard.save
            format.html { redirect_to admin_wizard_path(@wizard), notice: 'Wizard was successfully created.' }
      ...
      def update
        ...
        respond_to do |format|
          if @wizard.update_attributes(params[:wizard])
            format.html { redirect_to admin_wizard_path(@wizard), notice: 'Wizard was successfully updated.' }
      ...
      def destroy
        ...
        respond_to do |format|
          format.html { redirect_to admin_wizards_url }
          format.json { head :no_content }
        end
      end
